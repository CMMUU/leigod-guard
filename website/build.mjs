...
const application = {
  ...
  url: site.origin + '/',
  description: '支持雷神与外星仔加速器的独立开源 Windows 计时守护工具，支持按游戏进程暂停计时与查询剩余时长。',
...
const structuredData = JSON.stringify({
  ...
  '@graph': [
    ...
    { '@type': 'WebPage', '@id': site.origin + '/#webpage', url: site.origin + '/', name: '加速器守护 · 雷神与外星仔自动暂停计时工具', inLanguage: 'zh-CN', dateModified: lastModified, isPartOf: { '@id': site.origin + '/#website' }, about: { '@id': application['@id'] } },
    application,
