...
后台 0.5.0 增加独立开启的“网吧模式”：用户登录网页可为已授权账号设置连续未暂停时长，默认 24 小时，可选 1–168 小时。开启后该账号的云端任务按时长上限执行，无需网吧电脑安装守护或浏览器保持打开。设置、计时和任务保存在 PostgreSQL，详见 [网吧模式规则](../docs/REMOTE_PROTECTION.md#网吧模式后台-050)。
